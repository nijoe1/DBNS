...
export default function Footer() {
  return (
    <footer className="relative mt-20 bg-black/80 bottom-0 rounded-t-lg">
        ...
        <div className="flex flex-col items-center gap-5">
          <div className="flex items-center gap-3">
            ...
            <Link
              ...
              href="https://github.com/nijoe1/DBNS"
            >
              Fork me
            </Link>
          </div>
          <p className="text-lg text-center text-white/90">
            Build with ❤️ for Filecoin DataEconomy Hackathon from
